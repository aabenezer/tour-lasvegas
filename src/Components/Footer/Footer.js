                ...
                <div className='footer-sections-1'>
                    ...
                    <div className='footer-links-main'>
                        ...
                        <div className='footer-links'>
                            ...
                            <ul className='footer-links-lists' >
                                <a href="https://www.lasvegasnevada.gov/" class="link" target="_blank" rel="noopener noreferrer">City of Las Vegas</a>
                                <a href="https://www.lvcva.com/" class="link" target="_blank" rel="noopener noreferrer">Las vegas convention center</a>
                                <a href="https://www.harryreidairport.com/" class="link" target="_blank" rel="noopener noreferrer">Harry Reid International Airport</a>
                                <a href="https://www.rtcsnv.com/" class="link" target="_blank" rel="noopener noreferrer">RTC of Southern Nevada</a>
                            </ul>
                        </div>
                    </div>
